...
export function AnimatedCards({ cards }: Props) {
  ...
  return (
    <>
                ...
                <div className="flex justify-between items-center p-4">
                  <div className="">
                    <motion.h3
                      ...
                      className="text-neutral-700 dark:text-neutral-200 text-2xl font-semibold"
                    >
                      {active.title}
                    </motion.h3>
                    {/* <motion.p
      ...
      <ul className="max-w-4xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 items-start gap-4">
